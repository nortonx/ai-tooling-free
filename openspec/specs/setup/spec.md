...
## Purpose
Installing this repository's skills globally via the Agent Skills CLI and placing Claude Code subagents where Claude Code reads them, on macOS/Linux/WSL2 and Windows.
